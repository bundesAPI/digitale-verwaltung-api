...
class ARSApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_all1_endpoint = _Endpoint(
            settings={
                "response_type": (PageArsDto,),
                "auth": [],
                "endpoint_path": "/v1/ars",
                "operation_id": "find_all1",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def find_all1(self, **kwargs):
        """Informationen zu Gebietskörperschaften in Deutschland  # noqa: E501

        Liefert amtliche Regionalschlüssel und Bezeichnungen zu allen Gebietskörperschaften innerhalb Deutschlands.  # noqa: E501
        ...
        return self.find_all1_endpoint.call_with_http_info(**kwargs)
