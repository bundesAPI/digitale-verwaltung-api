...
from deutschland.digitale_verwaltung import rest
...
from deutschland.digitale_verwaltung.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ARSApi()
        api_instance.find_all1  # this is an instance of the class Endpoint
        api_instance.find_all1()  # this invokes api_instance.find_all1.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.find_all1.callable or self.callable in this class
